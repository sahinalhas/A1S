...
import { EnhancedRiskPredictionService } from '../../risk-management/services/enhanced-risk-prediction.service.js';
import { PersonalizedLearningService } from '../../../services/personalized-learning.service.js';
...
export class AdvancedAnalyticsDashboardService {
  ...
  private identifyUpcomingActions(riskScore: Record<string, any>, insights: Array<{ type: string; actionRequired?: boolean; suggestedAction?: string; title: string; category: string }>) {
