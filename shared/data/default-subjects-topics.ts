...
export const DEFAULT_SUBJECTS: SubjectData[] = [
  ...
  // ==================== LGS ====================
  {
    ...
    topics: [
      {
        name: 'Sözcükte Anlam (Gerçek, Yan, Mecaz)',
        avgMinutes: 60,
        energyLevel: 'medium',
        difficultyScore: 5,
        priority: 8,
      ...
      {
        name: 'Sözcük Türleri (İsim, Sıfat, Zamir)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Paragraf (Ana Fikir, Yardımcı Fikir)',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Basit Olayların Olasılığı',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 7,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Elektrik Yükleri ve Elektriklenme',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 7,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Milli Mücadeleye Hazırlık',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
  ...
  // ==================== TYT ====================
  {
    ...
    topics: [
      ...
      {
        name: 'Sözcük Yapısı (Kök, Gövde, Ek)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 5,
        priority: 7,
      ...
      {
        name: 'Fiilimsi (İsim-Fiil, Sıfat-Fiil, Zarf-Fiil)',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 8,
        priority: 9,
  ...
  },
  {
    ...
    topics: [
      {
        name: 'Sayılar (Tam, Rasyonel, Reel)',
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Oran-Orantı ve Problemler',
        avgMinutes: 150,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
      ...
      {
        name: 'Yüzde ve Kar-Zarar Problemleri',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Hareket ve İşçi Problemleri',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 8,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Hareket (Düzgün ve Düzgün Hızlanan)',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
      ...
      {
        name: 'Enerji (İş, Güç, Kinetik, Potansiyel)',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Hücre Zarı ve Madde Geçişi',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Besin Zinciri ve Madde Döngüleri',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 7,
  ...
  },
  {
    ...
    topics: [
      {
        name: 'İslam Tarihi ve Uygarlığı',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 7,
      ...
      {
        name: 'Osmanlı Islahat Hareketleri',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
  ...
  },
  {
    ...
    topics: [
      {
        name: 'Harita Bilgisi ve Koordinat Sistemi',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 7,
      ...
      {
        name: 'İklim Elemanları ve İklim Tipleri',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
  ...
  },
  {
    ...
    topics: [
      {
        name: 'Hücre Bölünmesi ve Kalıtım',
        avgMinutes: 150,
        energyLevel: 'high',
        difficultyScore: 8,
        priority: 9,
      ...
      {
        name: 'Genetik (DNA, RNA, Protein Sentezi)',
        avgMinutes: 180,
        energyLevel: 'high',
        difficultyScore: 9,
        priority: 10,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Nesir (Roman, Hikaye, Tiyatro)',
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Osmanlı Devleti (13-15. Yüzyıl)',
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 8,
      ...
      {
        name: 'Osmanlı Devleti (16-18. Yüzyıl)',
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 8,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: "Türkiye'nin Beşeri Özellikleri",
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Toplumsal Kurumlar (Aile, Eğitim, Din)',
        avgMinutes: 120,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 8,
      ...
      {
        name: 'Kentleşme ve Kentsel Sorunlar',
        avgMinutes: 60,
        energyLevel: 'low',
        difficultyScore: 5,
        priority: 6,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Peygamberlik ve Hz. Muhammed',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 5,
        priority: 7,
  ...
  // ==================== YDT ====================
  {
    ...
    topics: [
      ...
      {
        name: 'Future Tenses (Will, Going to)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 5,
        priority: 8,
      ...
      {
        name: 'Modal Verbs (Can, Could, May, Might)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 9,
      ...
      {
        name: 'Modal Verbs (Must, Should, Ought to)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Conditionals (If Clauses Type 0-3)',
        avgMinutes: 150,
        energyLevel: 'high',
        difficultyScore: 9,
        priority: 10,
      ...
      {
        name: 'Causative Verbs (Have/Get Something Done)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 7,
      ...
      {
        name: 'Cloze Test (Sentence Completion)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 9,
      ...
      {
        name: 'Finding Irrelevant Sentence',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 6,
        priority: 8,
      ...
      {
        name: 'Paraphrasing (Similar Meaning)',
        avgMinutes: 90,
        energyLevel: 'medium',
        difficultyScore: 7,
        priority: 7,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Zamanlar ve Fiil Çekimleri',
        avgMinutes: 150,
        energyLevel: 'high',
        difficultyScore: 8,
        priority: 9,
      ...
      {
        name: 'Cümle Yapısı ve Sözdizimi',
        avgMinutes: 120,
        energyLevel: 'high',
        difficultyScore: 7,
        priority: 9,
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: 'Fiil Çekimleri ve Zamanlar',
        avgMinutes: 150,
        energyLevel: 'high',
        difficultyScore: 8,
        priority: 9,
