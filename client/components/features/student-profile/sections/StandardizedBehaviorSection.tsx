...
const { BEHAVIOR_CATEGORIES } = TAXONOMY;
...
const behaviorIncidentSchema = z.object({
  ...
  severity: z.enum(['DÜŞÜK', 'ORTA', 'YÜKSEK', 'ÇOK_YÜKSEK']).or(z.literal("")),
  frequency: z.enum(['TEK_OLAY', 'NADİR', 'HAFTALIK', 'GÜNLÜK', 'SÜREKLİ']).or(z.literal("")),
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <div className="flex gap-2 mt-1">
                            <span className={`text-xs px-2 py-0.5 rounded ${incident.severity === 'ÇOK_YÜKSEK' ? 'bg-red-100 text-red-800' :
