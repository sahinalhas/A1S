...
import { FileText, Clock, CheckCircle2, ChevronLeft, ChevronRight } from "lucide-react";
import {
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              ...
              {["Okul", "LGS", "TYT", "AYT", "YDT"].map((cat) => (
                <Badge
                  ...
                  className={`cursor-pointer ${getCategoryColor(cat)}`}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-2 p-3 rounded-md bg-blue-50 border border-blue-200">
                      ...
                      <p className="text-xs text-blue-800">
                        Şablon uygulanırken mevcut tüm ders bloklarınız otomatik olarak silinecek ve yerlerine yeni program eklenecektir.
                      </p>
                    </div>
                  </div>
                ) : (
