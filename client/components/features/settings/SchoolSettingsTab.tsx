  ...
  const handleSetDefault = async (schoolId: string) => {
    try {
      ...
      if (result.success) {
        ...
        // Update local state with returned schools to show the badge immediately
        if (result.schools) {
          setSchools(result.schools);
        }
        // Also reload from auth context to keep everything in sync
        await loadUserSchools();
      } else {
              ...
              {schools.map((school, index) => (
                ...
                >
                  {editingSchool?.id === school.id ? (
                    ...
                    <Card className={`group hover:shadow-xl transition-all duration-300 border-1 hover:border-primary/30 cursor-pointer overflow-hidden ${school.isDefault === 1 ? 'ring-2 ring-yellow-400' : ''}`}>
                      <div className={`h-1 ${school.isDefault === 1 ? 'bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400' : 'bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500'}`} />
                      {school.isDefault === 1 && (
                        <div className="px-5 py-2 bg-yellow-50 dark:bg-yellow-950/30 border-b border-yellow-100 dark:border-yellow-900">
                          <p className="text-xs font-semibold text-yellow-700 dark:text-yellow-300">⭐ Varsayılan Okul</p>
                        </div>
                      )}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="w-40">
                                ...
                                {schools.length > 1 && school.isDefault !== 1 && (
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="newSchoolName" className="text-sm font-semibold min-h-[20px] block">Okul Adı *</Label>
                  <Input
                    id="newSchoolName"
                ...
                <div className="space-y-2">
                  <Label htmlFor="newSchoolCode" className="text-sm font-semibold min-h-[20px] block">Kurum Kodu (MEBBIS) *</Label>
                  <Input
                    id="newSchoolCode"
                    placeholder="Örn: 715044"
                  ...
                  />
                  <p className="text-xs text-muted-foreground min-h-[16px]">MEBBIS aktarımı için zorunludur</p>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="newSchoolPhone" className="text-sm font-semibold min-h-[20px] block">Telefon</Label>
                  <Input
                    id="newSchoolPhone"
                  ...
                  />
                  <p className="text-xs text-transparent min-h-[16px] select-none pointer-events-none">.</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="newSchoolEmail" className="text-sm font-semibold min-h-[20px] block">E-posta</Label>
                  <Input
                    id="newSchoolEmail"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="newSchoolAddress" className="text-sm font-semibold min-h-[20px] block">Adres</Label>
                  <Input
                    id="newSchoolAddress"
                ...
                <div className="space-y-2">
                  <Label htmlFor="newSchoolWebsite" className="text-sm font-semibold min-h-[20px] block">Web Sitesi</Label>
                  <Input
                    id="newSchoolWebsite"
                    type="url"
                    placeholder="https://..."
              ...
              {/* Column 3: Personnel & Social */}
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="newSchoolPrincipal" className="text-sm font-semibold min-h-[20px] block">Müdür Adı</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="newSchoolViceDirector" className="text-sm font-semibold min-h-[20px] block">Müdür Yardımcısı</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="newSchoolSocialMedia" className="text-sm font-semibold min-h-[20px] block">Sosyal Medya</Label>
                  <Input
